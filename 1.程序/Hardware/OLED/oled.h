...
#define OLED_SCLK_Clr() GPIO_ResetBits(OLED_SCLK_GPIO_PORT,OLED_SCLK_GPIO_PIN)
#define OLED_SCLK_Set() GPIO_SetBits(OLED_SCLK_GPIO_PORT,OLED_SCLK_GPIO_PIN)//SCL
